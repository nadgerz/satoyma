...
HTML.HTMLMetaElement.prototype.__defineGetter__("name", function() {
...
HTML.HTMLInputElement.prototype.__defineSetter__("checked", function(checked) {
  var _j, _len1, _ref1, _results;
  this._initDefaultChecked();
  if (checked) {
    this.setAttribute('checked', 'checked');
    if (this.type === 'radio') {
      _ref1 = this._ownerDocument.getElementsByName(this.name);
      _results = [];
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        element = _ref1[_j];
        if (element !== this && element.tagName === "INPUT" && element.type === "radio" && element.form === this.form) {
          _results.push(element.checked = false);
        } else {
...
HTML.HTMLImageElement.prototype._attrModified = function(name, value, oldVal) {
  if (name === 'src' && value !== oldVal) {
    return HTML.resourceLoader.load(this, value, function() {});
  }
};
