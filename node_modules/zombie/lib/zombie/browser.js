var Assert, BROWSER_FEATURES, BROWSER_OPTIONS, Browser, Console, Cookie, Cookies, Credentials, DEFAULT_FEATURES, DNSMask, Debug, EventEmitter, EventLoop, File, HTML, Interact, JSDOM_PATH, MOUSE_EVENT_NAMES, Mime, Path, PortMap, Q, Resources, Storages, Tough, URL, XPathResult, assert, createTabs, debug, format, ms,
...
Browser = (function(_super) {
  ...
  function Browser(options) {
    ...
    this.on("console", function(level, message) {
      if (!browser.silent) {
        return debug("console." + level + ": " + message);
      }
    });
