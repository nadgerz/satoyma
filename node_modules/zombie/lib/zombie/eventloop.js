var EventEmitter, EventLoop, EventQueue, Interval, Promise, Timeout, createDomain, ms,
...
EventLoop = (function(_super) {
  ...
  function EventLoop(browser) {
    ...
    this.domain.on("error", (function(_this) {
  ...
  EventLoop.prototype.wait = function(waitDuration, completionFunction) {
    var ondone, onerror, ontick, promise, timeout, timer;
    ...
    promise = promise["finally"]((function(_this) {
      return function() {
        clearInterval(timer);
        ...
        if (_this.waiting === 0) {
          setImmediate(function() {
            return _this.browser.emit("done");
          });
        }
      };
    })(this));
